...
class MyTheme {
  ...
  static const Color accent = Color(0xFF27457E);
  static const Color accent50 = Color(0x7727457E);
  static const Color accent80 = Color(0xAA27457E);
  ...
  static const Color button = Color(0xFF27457E);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
        primary: accent, secondary: accent, background: Color(0xFFF4F7FB)),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    scaffoldBackgroundColor: Color(0xFF091426),
    dialogBackgroundColor: Color(0xFF101D32),
    appBarTheme: AppBarTheme(
      shadowColor: Colors.transparent,
    ),
    dialogTheme: DialogTheme(
